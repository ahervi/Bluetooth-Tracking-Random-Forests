...
length1 = 1000
sizeX = 0.0009*len(XconsecutiveSignal)
...
for i in range(1,length1):
	...
	sizeTestX = float(i)*sizeX
	per.append(int(100*float(i)*length1))
	Yshould = Ypred
	clf4, YpredictionConsecutiveSignal4 = givesClassifier("4", DBS, Xt, Yt, sizeTestX, Xpred, Ypred)
