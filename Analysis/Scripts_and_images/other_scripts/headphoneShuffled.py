...
def probabilityPredictionMainAndSub(listAim, listAim1, listAim2, listAim3, listAim4, clf4, clf3_1, clf3_2, clf3_3, clf3_4, X, X1, X2, X3, X4, XuntouchedF,XuntouchedF1,XuntouchedF2,XuntouchedF3,XuntouchedF4, YuntouchedF):
	YpredictionConsecutiveSignal = []
	probas3_1 = clf3_1.predict_proba(listAim1)
	probas3_2 = clf3_2.predict_proba(listAim2)
	probas3_3 = clf3_3.predict_proba(listAim3)
	probas3_4 = clf3_4.predict_proba(listAim4)

	probas4 = clf4.predict_proba(listAim)
...
def probabilityPredictionSub(listAim, listAim1, listAim2, listAim3, listAim4, clf3_1, clf3_2, clf3_3, clf3_4, X1, X2, X3, X4, XuntouchedF,XuntouchedF1,XuntouchedF2,XuntouchedF3,XuntouchedF4, YuntouchedF):
	YpredictionConsecutiveSignal = []
	probas3_1 = clf3_1.predict_proba(listAim1)
	probas3_2 = clf3_2.predict_proba(listAim2)
	probas3_3 = clf3_3.predict_proba(listAim3)
...
def givesClassifier(cible, listAim, ID, DBS, XconsecutiveSignalCombinaisons, XconsecutiveSignal, YconsecutiveSignalCombinaisons, YconsecutiveSignal, XuntouchedF, YuntouchedF):
	clf4 = RandomForestClassifier(n_estimators=100)

	clf4 = clf4.fit(XconsecutiveSignal, YconsecutiveSignal)


	YpredictionConsecutiveSignal4 = clf4.predict(listAim)
	print(YpredictionConsecutiveSignal4)
	Yshould = [cible]*len(listAim)
	ratio4 = 0
	...
	print(str(len(Yshould)- errors4) + " errors ( " + str(100-100*float(errors4)/len(Yshould))+ "% ) on " + str(len(Yshould)) + " predicted samples out of " + str(len(XconsecutiveSignal)) + " training samples : ")
...
def givesAimList(DB_NAME, BSSID):
...
DBS = [[DB_NAME, "C1:CF:31:F3:29:6C", "russia"], [DB_NAME, "C7:64:6C:03:B9:40", "me"],
 [DB_NAME, "DA:E7:8C:CA:05:CF", "fenetre_casque"], [DB_NAME, "F2:39:F2:6A:80:89", "fenetre_russia"], [DB_NAME, "C7:62:97:12:1E:35", "the"],
  [DB_NAME, "E4:FA:6E:AF:58:19", "carte_bancaire"]]
XuntouchedF4 = []
...
cibleBSSID = "C7:64:6C:03:B9:40"
cible = "me"
bigListAim = givesAimList(DB_NAME + ".db", cibleBSSID)
listAim, listAim1, listAim2, listAim3, listAim4 = bigListAim[2], bigListAim[3][0], bigListAim[3][1], bigListAim[3][2], bigListAim[3][3] 
random.seed(1)
...
Yshould = [cible]*len(listAim)
clf4, YpredictionConsecutiveSignal4 = givesClassifier(cible, listAim, "4", DBS, XconsecutiveSignalCombinaisons, XconsecutiveSignal, YconsecutiveSignalCombinaisons, YconsecutiveSignal, XuntouchedF, YuntouchedF)
clf3_1, YpredictionConsecutiveSignal3_1 = givesClassifier(cible, listAim1, "3_1", DBS, XconsecutiveSignalCombinaisons1, XconsecutiveSignal1, YconsecutiveSignalCombinaisons, YconsecutiveSignal, XuntouchedF1, YuntouchedF)
clf3_2, YpredictionConsecutiveSignal3_2 = givesClassifier(cible, listAim2, "3_2", DBS, XconsecutiveSignalCombinaisons2, XconsecutiveSignal2, YconsecutiveSignalCombinaisons, YconsecutiveSignal, XuntouchedF2, YuntouchedF)
clf3_3, YpredictionConsecutiveSignal3_3 = givesClassifier(cible, listAim3, "3_3", DBS, XconsecutiveSignalCombinaisons3, XconsecutiveSignal3, YconsecutiveSignalCombinaisons, YconsecutiveSignal, XuntouchedF3, YuntouchedF)
clf3_4, YpredictionConsecutiveSignal3_4 = givesClassifier(cible, listAim4, "3_4", DBS, XconsecutiveSignalCombinaisons4, XconsecutiveSignal4, YconsecutiveSignalCombinaisons, YconsecutiveSignal, XuntouchedF4, YuntouchedF)
...
print(100-100*float(errors)/len(Yshould))
...
YpredictionConsecutiveSignal = probabilityPredictionMainAndSub(listAim, listAim1, listAim2, listAim3, listAim4, clf4, clf3_1, clf3_2, clf3_3, clf3_3, XconsecutiveSignal, XconsecutiveSignal1, XconsecutiveSignal2, XconsecutiveSignal3, XconsecutiveSignal4, XuntouchedF,XuntouchedF1,XuntouchedF2,XuntouchedF3,XuntouchedF4, YuntouchedF)
ratio = 0
...
YpredictionConsecutiveSignal = probabilityPredictionSub(listAim, listAim1, listAim2, listAim3, listAim4, clf3_1, clf3_2, clf3_3, clf3_3, XconsecutiveSignal1, XconsecutiveSignal2, XconsecutiveSignal3, XconsecutiveSignal4, XuntouchedF,XuntouchedF1,XuntouchedF2,XuntouchedF3,XuntouchedF4, YuntouchedF)
ratio = 0
for k in range(len(YpredictionConsecutiveSignal)):
