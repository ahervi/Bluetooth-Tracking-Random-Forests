...
import math
import datetime
#To use in conjonction with test_on_db.py to assess the quality of a given training
...
def maj():
	...
	DB_NAME = "THURSDAYWEEK4AFTERNOON"
	...
	if TEST == 0:
		...
		sizeTest = 1
		Yshould = givesYshould(sizeTest, XconsecutiveSignal, YconsecutiveSignal)
		clf4 = givesClassifier("4", DBS, XconsecutiveSignalCombinaisons, XconsecutiveSignal, YconsecutiveSignalCombinaisons, YconsecutiveSignal, sizeTest)
		clf3_1 = givesClassifier("3_1", DBS, XconsecutiveSignalCombinaisons1, XconsecutiveSignal1, YconsecutiveSignalCombinaisons, YconsecutiveSignal, sizeTest)
		clf3_2 = givesClassifier("3_2", DBS, XconsecutiveSignalCombinaisons2, XconsecutiveSignal2, YconsecutiveSignalCombinaisons, YconsecutiveSignal, sizeTest)
		clf3_3= givesClassifier("3_3", DBS, XconsecutiveSignalCombinaisons3, XconsecutiveSignal3, YconsecutiveSignalCombinaisons, YconsecutiveSignal, sizeTest)
		clf3_4 = givesClassifier("3_4", DBS, XconsecutiveSignalCombinaisons4, XconsecutiveSignal4, YconsecutiveSignalCombinaisons, YconsecutiveSignal, sizeTest)
