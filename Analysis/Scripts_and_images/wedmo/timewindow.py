...
def givesClassifier(ID, DBS, XconsecutiveSignal, YconsecutiveSignal, sizeTest, Xpred, Ypred):
	...
	#with open("randomForestModel" + str(ID) ,"wb") as f:
		#pickle.dump(clf4, f)
	return clf4, 100-100*float(errors4)/len(Yshould)
...
Xpred3 = []
Xpred4 = []
for TIME_WINDOW in range(1,100):
	...
	graph.append(YpredictionConsecutiveSignal4)
