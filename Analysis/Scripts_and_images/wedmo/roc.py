...
for i in range(0,taille + 1):
	...
	Positive = float(len(YpredictionConsecutiveSignal))
	Negative = float(len(YpredictionConsecutiveSignal)*(len(YpredictionConsecutiveSignal[0])-1))
	graphP.append(float(Positive-falseNegative)/Positive)
	per.append(falsePositive/Negative)
	print("true positive rate : " + str(float(Positive-falseNegative)/Positive))
	print("false positive rate : " + str(falsePositive/Negative))
