...
for i in range(0,taille + 1):
	...
	graphP.append(float(Negative-falsePositive)/Negative)
	per.append(falseNegative/Positive)
...
axes1.set_ylabel('True negative rate', color = 'black')
axes1.plot(per,graphP,color='black')



plt.xlabel('False negative rate')
plt.savefig("inverseroc.png")
plt.show()