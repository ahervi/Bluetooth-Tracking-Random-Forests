...
DBS_PRED = [[DB_NAME, "C1:CF:31:F3:29:6C", "russia"], [DB_NAME, "C7:64:6C:03:B9:40", "me"], [DB_NAME, "DA:E7:8C:CA:05:CF", "fenetre_casque"], [DB_NAME, "F2:39:F2:6A:80:89", "fenetre_russia"], [DB_NAME, "C7:62:97:12:1E:35", "the"], [DB_NAME, "E4:FA:6E:AF:58:19", "carte_bancaire"]]
XuntouchedF4 = []
...
Xpred1.sort(key=lambda x: x[1])
Xpred2.sort(key=lambda x: x[1])
Xpred3.sort(key=lambda x: x[1])
Xpred4.sort(key=lambda x: x[1])
...
XconsecutiveSignal1 = [x[0] for x in XconsecutiveSignal1]
XconsecutiveSignal2 = [x[0] for x in XconsecutiveSignal2]
XconsecutiveSignal3 = [x[0] for x in XconsecutiveSignal3]
XconsecutiveSignal4 = [x[0] for x in XconsecutiveSignal4]
Xpred = [x[0] for x in Xpred]
Xpred1 = [x[0] for x in Xpred1]
Xpred2 = [x[0] for x in Xpred2]
Xpred3 = [x[0] for x in Xpred3]
Xpred4 = [x[0] for x in Xpred4]
YpredTemp = [x[0] for x in YpredTemp]
YconsecutiveSignalTemp = [x[0] for x in YconsecutiveSignalTemp]
graph = []
per = []
XconsecutiveSignal = XconsecutiveSignal[:int(0.5*len(XconsecutiveSignal))]
XconsecutiveSignal1 = XconsecutiveSignal1[:int(0.5*len(XconsecutiveSignal1))]
XconsecutiveSignal2 = XconsecutiveSignal2[:int(0.5*len(XconsecutiveSignal2))]
XconsecutiveSignal3 = XconsecutiveSignal3[:int(0.5*len(XconsecutiveSignal3))]
XconsecutiveSignal4 = XconsecutiveSignal4[:int(0.5*len(XconsecutiveSignal4))]
YconsecutiveSignalTemp = YconsecutiveSignalTemp[:int(0.5*len(YconsecutiveSignalTemp))]
Xpred = Xpred[int(0.5*len(Xpred)):]
Xpred1 = Xpred1[int(0.5*len(Xpred1)):]
Xpred2 = Xpred2[int(0.5*len(Xpred2)):]
Xpred3 = Xpred3[int(0.5*len(Xpred3)):]
Xpred4 = Xpred4[int(0.5*len(Xpred4)):]
YpredTemp = YpredTemp[int(0.5*len(YpredTemp)):]
...
for i in range(1,1000):
	...
	Yshould = YpredTemp
	clf4, YpredictionConsecutiveSignal4 = givesClassifier("4", DBS, XconsecutiveSignal, YconsecutiveSignalTemp, sizeTest, Xpred, YpredTemp)
	clf3_1, YpredictionConsecutiveSignal3_1 = givesClassifier("3_1", DBS,XconsecutiveSignal1, YconsecutiveSignalTemp, sizeTest, Xpred1, YpredTemp)
	clf3_2, YpredictionConsecutiveSignal3_2 = givesClassifier("3_2", DBS, XconsecutiveSignal2, YconsecutiveSignalTemp, sizeTest, Xpred2, YpredTemp)
	clf3_3, YpredictionConsecutiveSignal3_3 = givesClassifier("3_3", DBS, XconsecutiveSignal3, YconsecutiveSignalTemp, sizeTest, Xpred3, YpredTemp)
	clf3_4, YpredictionConsecutiveSignal3_4 = givesClassifier("3_4", DBS, XconsecutiveSignal4, YconsecutiveSignalTemp, sizeTest, Xpred4, YpredTemp)
