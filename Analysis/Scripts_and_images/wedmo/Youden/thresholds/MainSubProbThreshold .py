...
plt.savefig("youdenIndexMSProb.png")
...
axes1.set_xlabel('threshold')
plt.savefig("bothNumberMSProb.png")
plt.show()
...
axes1.set_xlabel('threshold')
plt.savefig("falsenegMSProb.png")
plt.show()
plt.clf()
plt.close()
fig, axes1 = plt.subplots() 
...
axes1.set_xlabel('threshold')
plt.savefig("falseposMSProb.png")
plt.show()
