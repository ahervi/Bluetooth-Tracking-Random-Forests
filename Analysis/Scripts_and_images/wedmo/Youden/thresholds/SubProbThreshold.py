...
plt.savefig("youdenIndexSubProb.png")
...
axes1.set_xlabel('threshold')
plt.savefig("bothNumberSubProb.png")
plt.show()
...
axes1.set_xlabel('threshold')
plt.savefig("falsenegSubProb.png")
plt.show()
plt.clf()
plt.close()
fig, axes1 = plt.subplots() 
...
axes1.set_xlabel('threshold')
plt.savefig("falseposSubProb.png")
plt.show()
