...
def givesClassifier(ID, DBS, XconsecutiveSignalCombinaisons, XconsecutiveSignal, YconsecutiveSignalCombinaisons, YconsecutiveSignal, sizeTest, XuntouchedF, YuntouchedF, trees):
	clf4 = RandomForestClassifier(n_estimators=trees)
...
for i in range(10, NumberTrees, 10):
	...
	for j in range(NumberClf):
		sizeTest = 0.999
		Yshould = YuntouchedF
		clf4, YpredictionConsecutiveSignal4 = givesClassifier("4", DBS, XconsecutiveSignalCombinaisons, XconsecutiveSignal, YconsecutiveSignalCombinaisons, YconsecutiveSignal, sizeTest, XuntouchedF, YuntouchedF, i)
	...
	graph.append(100*float(mean)/(len(Yshould)))
	per.append(i)
print(graph)
