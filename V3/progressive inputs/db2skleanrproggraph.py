...
# prints the graphs for progressive inputs for the WEEK4 category database
...
graph4 = []
per = []
for seconds in [x*30 for x in range(1,40)]:
	...
	meanLocale3 = 0
	meanLocale4 = 0
	XpartialC = timeseparation(XconsecutiveSignalCombinaisons, seconds)
	Xpartial1C = timeseparation(XconsecutiveSignalCombinaisons1, seconds)
	Xpartial2C = timeseparation(XconsecutiveSignalCombinaisons2, seconds)
	Xpartial3C = timeseparation(XconsecutiveSignalCombinaisons3, seconds)
	Xpartial4C = timeseparation(XconsecutiveSignalCombinaisons4, seconds)
	Xpartial = timeseparation(XconsecutiveSignal, seconds)
	Xpartial1 = timeseparation(XconsecutiveSignal1, seconds)
	Xpartial2 = timeseparation(XconsecutiveSignal2, seconds)
	Xpartial3 = timeseparation(XconsecutiveSignal3, seconds)
	Xpartial4 = timeseparation(XconsecutiveSignal4, seconds)
	YpartialC = timeseparation(YconsecutiveSignalCombinaisonsTemp, seconds)
	Ypartial = timeseparation(YconsecutiveSignalTemp, seconds)
...
plt.xlabel('training interval (seconds)')
